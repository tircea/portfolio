...
chastiMoviStart = list_chunk(chastiMovi, limit_data)[0] 
viborka = list_chunk(result, limit_data)[0]
...
for cur_word in set(viborka):
    ...
    pos = parsedWord.tag.POS.lower()
    

    ### 
    req1 = """
    INSERT INTO ЧС_all (словоформа, лема, pos, обща_частота, підв_1, підв_2, підв_3, підв_4, підв_5, підв_6, підв_7, підв_8, підв_9, 
                            підв_10, підв_11, підв_12, підв_13, підв_14, підв_15, підв_16, підв_17, підв_18, підв_19, підв_20) VALUES
            (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """

    params = [cur_word, normalForm, pos, sum(freqs)] + freqs

    db.executeSql(req1, params)
    ### 
